...
namespace CodeGenerators
{
    ...
    public class CloneableGenerator : ISourceGenerator
    {
        ...
        private const string CloneableNamespace = "CoreCodeGenerators";
...
";
        ...
        {
            if (context.SyntaxReceiver is not CloneableSyntaxReceiver receiver)
                return;
...
{string.Join($",{Environment.NewLine}", fieldAssignmentsCodeSafe)}
        ...
        private static IEnumerable<INamedTypeSymbol> GetClassSymbols(Compilation compilation, CloneableSyntaxReceiver receiver)
        {
    ...
    internal class CloneableSyntaxReceiver : ISyntaxReceiver
    {
